...
#    pyautogui.alert ('O código está sendo executado. Não mexa no Computdor!') # Exibe caixa de alerta ao executar o script
    ...
    pyautogui.write (f"{numero_pagina:03d}") # escrevendo o número da página do ebook. (a cada loop do script é escrito o número da pagina correspondente do PDF, sendo que o pdf tem 545 paginas)
    ...
    time.sleep (3) # espere 3 segundos
    pyautogui.write (f"{numero_pagina:03d}") # escrevendo nome do arquivo (Repete o processo da linha "40", onde cada nome deverá ter como nome o número da pagina correspondente do PDF, sendo que o pdf tem 545 paginas)
    time.sleep (3) # espere 3 segundos
        #Salvar
